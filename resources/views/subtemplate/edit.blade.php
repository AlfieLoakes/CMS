...
@section('content')
    <form method="POST" action="/admin/site/{{ $site->id }}/subtemplate/{{ $subtemplate->id }}">
        @method('PATCH')
        @csrf
        <div class="card">
            <div class="card-body">
                <h5>subtemplate Settings</h5>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            <label for="inputPassword" class="col-sm-2 col-form-label">Name</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name" value="{{ $subtemplate->name }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="inlineRadio1"  value="1" @if( $subtemplate->status == 1) checked @endif>
                                    <label class="form-check-label" for="inlineRadio1">Enabled</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="inlineRadio2" value="0" @if( $subtemplate->status == 0) checked @endif>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="collapse show" id="collapseHead">
                    <div id="headeditor">{{ $subtemplate->head }}</div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="collapse show" id="collapseExample">
                    <div id="bodyeditor">{{ $subtemplate->body }}</div>
                </div>
                <script>
                    $( document ).ready(function() {
                        //NEW WAY
        ...
        <div class="card">
            <div class="card-body">
                <h5>CSS</h5>
                <p>Edit stylesheet</p>
                <div id="csseditor">{{ $subtemplate->css }}</div>
                ...
                <textarea name="head" style="display: none;" id="headedit">{!! $subtemplate->head!!}</textarea>
                <textarea name="body" style="display: none;" id="bodyedit" >{!! $subtemplate->body !!}</textarea>
                <textarea name="css" style="display: none;" id="cssedit" >{!! $subtemplate->css !!}</textarea>
